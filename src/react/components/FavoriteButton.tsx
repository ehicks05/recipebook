            ...
            <IconContext.Provider value={{size: size}}>
                {
                    (recipeId && favoriteIds.includes(recipeId))
                        ...
                        ? <BsFillHeartFill onMouseEnter={iconHover} onMouseLeave={iconLeaveHover} onClick={removeFavorite}  />
                        : <BiHeart onMouseEnter={iconHover} onMouseLeave={iconLeaveHover} onClick={saveFavorite} />
                }
